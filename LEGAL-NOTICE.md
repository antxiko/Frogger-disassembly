...
**The game is not ours.** *Frogger* was published by **Konami** as the
RC-704 cartridge for the MSX; the cartridge itself signs «KONAMI 1983». All rights over the game remain with their
holders.
...
The file `src/frogger.asm` is the commented disassembly of the cartridge. It
...
If you worked on *Frogger* or hold rights over the game, and you would
