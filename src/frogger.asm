...
BORRA_SEIS_BYTES:
	...
	ld (0e001h),a		;45da
VUELTA_AL_TITULO:
	ld bc,00060h		;45dd   ; borra de 0xE040 a 0xE09F: fase, casas y puntos de los dos jugadores
	ld hl,0e040h		;45e0
...
OCHO_BYTES_AL_REVES:
	...
	djnz OCHO_BYTES_AL_REVES		;47f7
	pop hl			;47f9
	pop bc			;47fa
	djnz GRUPO_INVERTIDO		;47fb
	inc hl			;47fd
	pop bc			;47fe
	djnz SUBE_DEL_REVES		;47ff
	ret			;4801
...
MONTA_EL_RIO:
	...
	ld de,0e44eh		;489e
	ld ix,0e44ah		;48a1
	call MONTA_DESDE_PLANTILLA		;48a5
...
UN_CARACTER_DEL_LARGO:
	...
	ex af,af'			;48f5
	djnz UN_CARACTER_DEL_LARGO		;48f6
...
PINTA_LOS_CUATRO:
	...
	ld hl,0e2b2h		;5014
	ld de,07b0ch		;5017
	call COLOREA_EL_COCODRILO		;501a
...
PINTA_LA_CABEZA:
	...
	ld hl,0e2beh		;502d
	ld de,07b10h		;5030
	call COLOREA_EL_COCODRILO		;5033
TROZO_A_TROZO:
	ld c,b			;5036   ; una ficha de sprite, cuatro bytes
	ld b,004h		;5037
	call SUBE_B_BYTES		;5039
	push bc			;503c
...
LA_RANA_RESCATABLE:
	...
	ld de,0e2a5h		;5070
	ld iy,0e2a0h		;5073
	ld (iy+003h),058h		;5077   ; color 0x58
BAJA_LA_CUENTA:
	dec (hl)			;507b
...
; ----------------------------------------------------------------------
; EL RELOJ DE LA PARTIDA. El tiempo arranca en 0x96 -150 en BCD- y baja uno cada 20 fotogramas. Al llegar a cero la rana muere. Por el camino pasan dos cosas que no se ven jugando: a los 0x60 cuatro objetos de la fila 15 se hacen mas rapidos, y a los 0x32 el caracter de la barra cambia de color.
; ----------------------------------------------------------------------
EL_RELOJ:
	ld hl,0e053h		;50fb
...
QUITA_EL_BIT_DE_ENCIMA:
	...
	inc hl			;5113
	inc hl			;5114
	djnz QUITA_EL_BIT_DE_ENCIMA		;5115
	jp SE_MUERE		;5117
MIRA_LOS_0x60:
...
CUATRO_MAS_RAPIDOS:
	...
	ld a,004h		;5131
	call HL_MAS_A		;5133
	djnz CUATRO_MAS_RAPIDOS		;5136
YA_ACELERARON:
	pop hl			;5138
	jr LA_BARRA_DEL_TIEMPO		;5139
MIRA_LOS_0x32:
	push af			;513b
	jr nc,COMPARA_CON_0x32		;513c
	ld a,(0e029h)		;513e
	or a			;5141
...
SE_MUERE:
	...
	jr nz,BORRA_LA_BANDERA		;5310
	ld l,08bh		;5312
BORRA_LA_BANDERA:
	ld (hl),000h		;5314   ; la fase deja de estar montada, para que se vuelva a montar
...
PON_EL_TIEMPO:
	ld hl,0e052h		;5503
	ld (hl),096h		;5506   ; el tiempo arranca en 150
	ld hl,0e053h		;5508
...
CASA_A_CASA:
	...
	push de			;557b
	call PINTA_LA_RANA_EN_CASA		;557c
	pop de			;557f
SIGUIENTE_CASA:
